...
public class Item extends GeneratableElement
	...
	public BufferedImage generateModElementPicture() {
		return ImageUtils.resizeAndCrop(
				hasGUITexture() ? guiTexture.getImage(TextureType.ITEM) : texture.getImage(TextureType.ITEM),
				32
		);
	}
	...
	@Override public List<TabEntry> getCreativeTabs() { return creativeTabs; }
	@Override public TextureHolder getTexture() { return texture; }
	...
	@Override public List<MCItem> getCreativeTabItems() { return providedMCItems(); }
	@Override public StringListProcedure getSpecialInfoProcedure() { return specialInformation; }
	...
	public static class StateEntry implements IWorkspaceDependent {
		...
		@Nullable private transient Workspace workspace;

		@Override public void setWorkspace(@Nullable Workspace workspace) { this.workspace = workspace; }
		@Nullable @Override public Workspace getWorkspace() { return workspace; }
	...
	public static Model.Type decodeModelType(int modelType) {
		return switch (modelType) {
			...
			default -> throw new IllegalStateException("Invalid model type: " + modelType);
		};
	}
}
